...
| --envvars | -e | No | Yes | A path to a json file with [User-defined Environment Variables (__VARS)](https://developer.electricimp.com/tools/impcentral/environmentvariables). A relative or absolute path can be used. The json file should contain a key-value table with the specified variables |
| --output | -z | No | Yes | Adjusts the [command’s output](#command-output) |
| --help | -h | No | No | Displays a description of the command. Ignores any other options |
...
| --envvars | -e | No | Yes | A path to a json file with [User-defined Environment Variables (__VARS)](https://developer.electricimp.com/tools/impcentral/environmentvariables). A relative or absolute path can be used. The json file should contain a key-value table with the specified variables. An empty table deletes the variables |
| --output | -z | No | Yes | Adjusts the [command’s output](#command-output) |
| --help | -h | No | No | Displays a description of the command. Ignores any other options |
